...
namespace LAYHER.Backend.Infraestructure.Eventos
{
    public class EventosRepository : IEventosRepository
    {
        ...
        public EventosRepository(ICustomConnection _connection)
        {
        ...
        public async Task<List<ListarEventosAdmin>> AdminListarEventos(int perfil, int usuario, string departamento, string provincia, string distrito, string titulo)
        {
